    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 items-center">
        ...
        <div className="md:col-span-5 flex justify-center md:justify-start">
          <div className="relative w-full max-w-[400px] aspect-square rounded-[32px] border border-zinc-100 dark:border-zinc-850 bg-zinc-50/50 dark:bg-zinc-900/30 p-5 shadow-sm">
            <div className="w-full h-full rounded-2xl border border-zinc-200/80 dark:border-zinc-800 overflow-hidden bg-zinc-100 dark:bg-zinc-900 relative">
              <img
                src="/NK_image.jpg"
        ...
        <div className="md:col-span-7 flex flex-col justify-center">
          ...
          {/* Heading */}
          <h2 className="font-space-grotesk text-3xl font-bold tracking-tight text-zinc-900 dark:text-white sm:text-4xl mt-4 leading-tight">
            Engineering with Passion and Precision
          </h2>

          {/* Description */}
          <p className="text-zinc-500 dark:text-zinc-400 text-sm sm:text-base leading-relaxed mt-4">
          ...
          <div className="flex items-center gap-4 mt-6">
            <a
              ...
              className="flex items-center gap-2 px-4 py-2 border border-zinc-150 dark:border-zinc-800 rounded-xl bg-white dark:bg-zinc-900 text-zinc-700 dark:text-zinc-300 hover:text-zinc-950 dark:hover:text-white hover:bg-zinc-50 dark:hover:bg-zinc-800 shadow-sm transition-all duration-300 hover:scale-105"
            >
